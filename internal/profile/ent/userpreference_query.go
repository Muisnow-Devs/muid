...
func (_q *UserPreferenceQuery) QueryUser() *UserProfileQuery {
...
func (_q *UserPreferenceQuery) WithUser(opts ...func(*UserProfileQuery)) *UserPreferenceQuery {
	query := (&UserProfileClient{config: _q.config}).Query()
...
func (_q *UserPreferenceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserPreference, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *UserPreference, e *UserProfile) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserPreferenceQuery) loadUser(ctx context.Context, query *UserProfileQuery, nodes []*UserPreference, init func(*UserPreference), assign func(*UserPreference, *UserProfile)) error {
...
func (_q *UserPreferenceQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(userpreference.FieldUserID)
		}
	}
