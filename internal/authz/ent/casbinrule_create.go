...
func (_c *CasbinRuleCreate) SetID(v uuid.UUID) *CasbinRuleCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *CasbinRuleCreate) SetNillableID(v *uuid.UUID) *CasbinRuleCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *CasbinRuleCreate) createSpec() (*CasbinRule, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(casbinrule.Table, sqlgraph.NewFieldSpec(casbinrule.FieldID, field.TypeUUID))
	)
