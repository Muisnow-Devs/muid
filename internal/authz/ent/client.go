...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.AuditLog, c.CasbinRule, c.Organization, c.OrganizationMember,
		c.OrganizationRole, c.PolicyRevision, c.UserRef,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		AuditLog, CasbinRule, Organization, OrganizationMember, OrganizationRole,
		PolicyRevision, UserRef []ent.Hook
	}
	inters struct {
		AuditLog, CasbinRule, Organization, OrganizationMember, OrganizationRole,
		PolicyRevision, UserRef []ent.Interceptor
	}
)
