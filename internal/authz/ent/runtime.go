...
func init() {
	...
	oidcgrantDescAuthorizedAt := oidcgrantFields[4].Descriptor()
	...
	oidcgrantDescCreatedAt := oidcgrantFields[7].Descriptor()
	...
	oidcgrantDescUpdatedAt := oidcgrantFields[8].Descriptor()
