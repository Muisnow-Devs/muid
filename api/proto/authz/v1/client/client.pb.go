...
func (x *AuthorizedClient) Reset() {
	*x = AuthorizedClient{}
	mi := &file_authz_v1_client_proto_msgTypes[0]
...
var File_authz_v1_client_proto protoreflect.FileDescriptor

const file_authz_v1_client_proto_rawDesc = "" +
	"\n" +
	"\x15authz/v1/client.proto\x12\x14muid.authz.v1.client\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe7\x01\n" +
	...
	"lastUsedAtB\xcb\x01\n" +
	"\x18com.muid.authz.v1.clientB\vClientProtoP\x01Z.sanzi.io/muid/api/proto/authz/v1/client;client\xa2\x02\x04MAVC\xaa\x02\x14Muid.Authz.V1.Client\xca\x02\x14Muid\\Authz\\V1\\Client\xe2\x02 Muid\\Authz\\V1\\Client\\GPBMetadata\xea\x02\x17Muid::Authz::V1::Clientb\x06proto3"

var file_authz_v1_client_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_authz_v1_client_proto_goTypes = []any{
	(*AuthorizedClient)(nil),      // 0: muid.authz.v1.client.AuthorizedClient
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_authz_v1_client_proto_depIdxs = []int32{
	1, // 0: muid.authz.v1.client.AuthorizedClient.authorized_at:type_name -> google.protobuf.Timestamp
	1, // 1: muid.authz.v1.client.AuthorizedClient.last_used_at:type_name -> google.protobuf.Timestamp
...
func init() { file_authz_v1_client_proto_init() }
func file_authz_v1_client_proto_init() {
	if File_authz_v1_client_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_authz_v1_client_proto_rawDesc), len(file_authz_v1_client_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_authz_v1_client_proto_goTypes,
		DependencyIndexes: file_authz_v1_client_proto_depIdxs,
		MessageInfos:      file_authz_v1_client_proto_msgTypes,
	}.Build()
	File_authz_v1_client_proto = out.File
	file_authz_v1_client_proto_goTypes = nil
	file_authz_v1_client_proto_depIdxs = nil
}
