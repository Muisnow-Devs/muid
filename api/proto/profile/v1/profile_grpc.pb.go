...
const (
	ProfileService_CreateProfile_FullMethodName        = "/muid.profile.v1.ProfileService/CreateProfile"
	ProfileService_GetProfile_FullMethodName           = "/muid.profile.v1.ProfileService/GetProfile"
	ProfileService_UpdateProfile_FullMethodName        = "/muid.profile.v1.ProfileService/UpdateProfile"
	ProfileService_StartAvatarUpload_FullMethodName    = "/muid.profile.v1.ProfileService/StartAvatarUpload"
	ProfileService_CompleteAvatarUpload_FullMethodName = "/muid.profile.v1.ProfileService/CompleteAvatarUpload"
)
...
func (c *profileServiceClient) StartAvatarUpload(ctx context.Context, in *StartAvatarUploadRequest, opts ...grpc.CallOption) (*StartAvatarUploadResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StartAvatarUploadResponse)
	err := c.cc.Invoke(ctx, ProfileService_StartAvatarUpload_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *profileServiceClient) CompleteAvatarUpload(ctx context.Context, in *CompleteAvatarUploadRequest, opts ...grpc.CallOption) (*CompleteAvatarUploadResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CompleteAvatarUploadResponse)
	err := c.cc.Invoke(ctx, ProfileService_CompleteAvatarUpload_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProfileServiceServer) StartAvatarUpload(context.Context, *StartAvatarUploadRequest) (*StartAvatarUploadResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StartAvatarUpload not implemented")
}
func (UnimplementedProfileServiceServer) CompleteAvatarUpload(context.Context, *CompleteAvatarUploadRequest) (*CompleteAvatarUploadResponse, error) {
...
func _ProfileService_StartAvatarUpload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StartAvatarUploadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProfileServiceServer).StartAvatarUpload(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProfileService_StartAvatarUpload_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).StartAvatarUpload(ctx, req.(*StartAvatarUploadRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ProfileService_CompleteAvatarUpload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompleteAvatarUploadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProfileServiceServer).CompleteAvatarUpload(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProfileService_CompleteAvatarUpload_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).CompleteAvatarUpload(ctx, req.(*CompleteAvatarUploadRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProfileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "muid.profile.v1.ProfileService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "StartAvatarUpload",
			Handler:    _ProfileService_StartAvatarUpload_Handler,
		},
		{
			MethodName: "CompleteAvatarUpload",
			Handler:    _ProfileService_CompleteAvatarUpload_Handler,
		},
	},
