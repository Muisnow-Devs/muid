...
type OrganizationRoleQuery struct {
	...
	withPermissions  *RolePermissionQuery
...
func (_q *OrganizationRoleQuery) QueryOrganization() *OrganizationQuery {
...
func (_q *OrganizationRoleQuery) QueryPermissions() *RolePermissionQuery {
...
func (_q *OrganizationRoleQuery) QueryMembers() *OrganizationMemberQuery {
...
func (_q *OrganizationRoleQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OrganizationRoleQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *OrganizationRoleQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *OrganizationRoleQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *OrganizationRoleQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *OrganizationRoleQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *OrganizationRoleQuery) WithOrganization(opts ...func(*OrganizationQuery)) *OrganizationRoleQuery {
	query := (&OrganizationClient{config: _q.config}).Query()
...
func (_q *OrganizationRoleQuery) WithPermissions(opts ...func(*RolePermissionQuery)) *OrganizationRoleQuery {
	query := (&RolePermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrganizationRoleQuery) WithMembers(opts ...func(*OrganizationMemberQuery)) *OrganizationRoleQuery {
	query := (&OrganizationMemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(organizationrole.FieldOrganizationID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.OrganizationRole.Query().
//		Select(organizationrole.FieldOrganizationID).
//		Scan(ctx, &v)
...
func (_q *OrganizationRoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*OrganizationRole, error) {
	...
	if query := _q.withPermissions; query != nil {
		if err := _q.loadPermissions(ctx, query, nodes,
			func(n *OrganizationRole) { n.Edges.Permissions = []*RolePermission{} },
			func(n *OrganizationRole, e *RolePermission) { n.Edges.Permissions = append(n.Edges.Permissions, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withMembers; query != nil {
		if err := _q.loadMembers(ctx, query, nodes,
			func(n *OrganizationRole) { n.Edges.Members = []*OrganizationMember{} },
			func(n *OrganizationRole, e *OrganizationMember) { n.Edges.Members = append(n.Edges.Members, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *OrganizationRoleQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*OrganizationRole, init func(*OrganizationRole), assign func(*OrganizationRole, *Organization)) error {
...
func (_q *OrganizationRoleQuery) loadPermissions(ctx context.Context, query *RolePermissionQuery, nodes []*OrganizationRole, init func(*OrganizationRole), assign func(*OrganizationRole, *RolePermission)) error {
	...
	query.Where(predicate.RolePermission(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(organizationrole.PermissionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *OrganizationRoleQuery) loadMembers(ctx context.Context, query *OrganizationMemberQuery, nodes []*OrganizationRole, init func(*OrganizationRole), assign func(*OrganizationRole, *OrganizationMember)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*OrganizationRole)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(organizationmember.FieldRoleID)
	}
	query.Where(predicate.OrganizationMember(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(organizationrole.MembersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *OrganizationRoleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(organizationrole.Table, organizationrole.Columns, sqlgraph.NewFieldSpec(organizationrole.FieldID, field.TypeUUID))
	_spec.From = _q.sql
