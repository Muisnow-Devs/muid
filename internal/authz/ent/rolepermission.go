...
type RolePermission struct {
	...
	// Permission identifier following the "resource:action" convention.
...
func (e RolePermissionEdges) RoleOrErr() (*OrganizationRole, error) {
	if e.Role != nil {
		return e.Role, nil
...
func (_m *RolePermission) QueryRole() *OrganizationRoleQuery {
