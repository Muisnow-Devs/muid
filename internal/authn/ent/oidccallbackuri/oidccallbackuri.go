...
const (
	// Label holds the string label denoting the oidccallbackuri type in the database.
	Label = "oidc_callback_uri"
	...
	EdgeClient = "client"
	// Table holds the table name of the oidccallbackuri in the database.
	Table = "oidc_callback_ur_is"
	// ClientTable is the table that holds the client relation/edge.
	ClientTable = "oidc_callback_ur_is"
...
// Columns holds all SQL columns for oidccallbackuri fields.
var Columns = []string{
	FieldID,
	FieldClientRefID,
	FieldURI,
...
// OrderOption defines the ordering options for the OIDCCallbackURI queries.
