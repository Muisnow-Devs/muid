...
func (_q *UserSessionQuery) QueryUser() *UserRefQuery {
...
func (_q *UserSessionQuery) WithUser(opts ...func(*UserRefQuery)) *UserSessionQuery {
	query := (&UserRefClient{config: _q.config}).Query()
...
func (_q *UserSessionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserSession, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *UserSession, e *UserRef) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserSessionQuery) loadUser(ctx context.Context, query *UserRefQuery, nodes []*UserSession, init func(*UserSession), assign func(*UserSession, *UserRef)) error {
