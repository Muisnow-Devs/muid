...
func init() {
	...
	// userfederatedidentityDescUserID is the schema descriptor for user_id field.
	userfederatedidentityDescUserID := userfederatedidentityFields[0].Descriptor()
	// userfederatedidentity.UserIDValidator is a validator for the "user_id" field. It is called by the builders before save.
	userfederatedidentity.UserIDValidator = userfederatedidentityDescUserID.Validators[0].(func(string) error)
	// userfederatedidentityDescProvider is the schema descriptor for provider field.
	userfederatedidentityDescProvider := userfederatedidentityFields[1].Descriptor()
	// userfederatedidentity.ProviderValidator is a validator for the "provider" field. It is called by the builders before save.
	userfederatedidentity.ProviderValidator = userfederatedidentityDescProvider.Validators[0].(func(string) error)
	// userfederatedidentityDescProviderUserID is the schema descriptor for provider_user_id field.
	userfederatedidentityDescProviderUserID := userfederatedidentityFields[2].Descriptor()
	// userfederatedidentity.ProviderUserIDValidator is a validator for the "provider_user_id" field. It is called by the builders before save.
	userfederatedidentity.ProviderUserIDValidator = userfederatedidentityDescProviderUserID.Validators[0].(func(string) error)
